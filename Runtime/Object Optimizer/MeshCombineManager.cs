...
namespace Lost
{
    ...
    public class MeshCombineManager : MonoBehaviour
    {
        ...
        [SerializeField] private int maxTriangleCount = 75000;
        [SerializeField] private float maxBoundsSize = 400;
        ...
        [ReadOnly] [SerializeField] private List<MeshCombineList> volumesMeshCombiners;
        ...
        public void DeleteVolumesMeshCombine()
        {
            ...
            {
                this.volumesMeshCombiners = new List<MeshCombineList>();
            }
        ...
        public void GenerateVolumesMeshCombine()
        {
            ...
            {
                GameObject volumeMeshCombine = new GameObject($"Volume {count++}", typeof(MeshCombineList));
                ...
                var meshCombineList = volumeMeshCombine.GetComponent<MeshCombineList>();
        ...
        private List<MeshRendererInfo> GetMeshRendererInfos()
        {
            ...
            foreach (var meshRenderersGameObject in this.meshRenderersGameObjects)
            {
                foreach (var meshRenderer in meshRenderersGameObject.GetComponentsInChildren<MeshRenderer>(true))
                {
                    ...
                    var ignore = meshRenderer.gameObject.GetComponentInParent<IgnoreMeshCombine>();
        ...
        public class MeshRendererInfo
        {
            ...
            [SerializeField] private IgnoreMeshCombine ignoreMeshCombine;
            ...
            public IgnoreMeshCombine IgnoreMeshCombine
            {
