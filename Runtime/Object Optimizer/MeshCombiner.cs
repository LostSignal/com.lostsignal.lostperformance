...
#pragma warning disable 0649
        [SerializeField] private List<LODSettings> lodSettings;
...
#pragma warning restore 0649
        ...
        private void OnValidate()
        {
            ...
            {
                this.lodSettings = new List<LODSettings>
                {
                    new LODSettings
                    {
                        Name = "LOD0",
        ...
        public void SimplifyLODMesh(int lodIndex)
        {
            ...
            var lodSettings = this.lodSettings[lodIndex];
            ...
            {
                var newMesh = this.CreateNewMesh(lodSettings, meshFilter);
        ...
        private Mesh CreateNewMesh(LODSettings lodSettings, MeshFilter meshFilter)
        {
            #if UNITY_EDITOR
